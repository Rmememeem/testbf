                ...
                OutlinedTextField(
                    ...
                    trailingIcon = {
                        Icon(
                            ...
                            modifier = Modifier.clickable(enabled = hasOptions) {
                                expanded = !expanded
                            }
                        )
                    }
    ...
    private fun isFormValid(
        ...
        if (winnerOne !in validNames || loserOne !in validNames) return false
        return when (matchType) {
            MatchType.SOLO -> winnerOne != loserOne
            MatchType.DUO -> {
                if (winnerTwo.isBlank() || loserTwo.isBlank()) return false
                if (winnerTwo !in validNames || loserTwo !in validNames) return false
